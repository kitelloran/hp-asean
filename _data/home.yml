...
main:
  ...
  markdownContent: |
    ...
    <div class="feature-content">
        ...
        <font size="5">an interactive, online platform for visualising trends and 
        <br>geographic variation in biodiversity indicators</font>
        <br><br>
...
stats:
  features:
    ...
    - title: <span id="datasetCount" class="ajax-is-loading">Loading</span>
      ...
      background: assets/icons/db-bio.png
